...
```sh
git add .
git commit -m "Добавлено описание функции git init в файле index.html"
```
**Задание 4**. Дополните файл style.css. Индексируйте измененные файлы и выполните коммит.
```sh
git add .
git commit -m "Добавлены параметры в файле style.css для отображения таблицы"
```
...
```sh
git push https://github.com/belred/lab-5.git
```
